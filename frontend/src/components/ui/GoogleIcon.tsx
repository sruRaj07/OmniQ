/**
 * OmniQ mobile app - Google "G" mark for the OAuth button.
 *
 * The four brand colours are fixed by Google's identity guidelines, so they are hardcoded rather
 * than pulled from the theme - a themed Google logo would be an off-brand Google logo.
 *
 * Author: OmniQ Team
 */
