    ...
    const runBurst = () => {
      ...
      const sparkleAnimations = sparkleAnims.map((s, i) => {
        ...
        return Animated.parallel([
          ...
          Animated.sequence([
            Animated.timing(s.scale, { toValue: 1.5, duration: 200, useNativeDriver: true }),
      ...
      Animated.parallel([
        ...
        Animated.sequence([
          ...
          Animated.timing(wobbleAnim, { toValue: -1, duration: 80, useNativeDriver: true }),
          Animated.timing(wobbleAnim, { toValue: 0.6, duration: 60, useNativeDriver: true }),
          Animated.timing(wobbleAnim, { toValue: -0.6, duration: 60, useNativeDriver: true }),
          Animated.timing(wobbleAnim, { toValue: 0.3, duration: 50, useNativeDriver: true }),
    ...
    <View style={styles.container}>
      ...
      <Animated.View
        style={[
          ...
          {
            transform: [{ scale: Animated.add(glowScale, -0.2) }],
